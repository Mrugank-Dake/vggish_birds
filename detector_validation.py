...
del_t = 0.1
for noise_value in range(2000, 34000, 1000):
  days = ['02', '04', '30']
  project_path = '/content/drive/My Drive/Sciurid Lab/CNN/VGGish_Birds/ARU_oct_annotations/'
  classifier_type = str(noise_value) + 'noise_100trees_classifier'
